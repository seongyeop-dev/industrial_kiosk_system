...
Industrial Kiosk System의 설계, 기능, 데이터 처리와 검증 내용을 문서별로 정리했습니다.

| 문서 | 내용 |
|---|---|
| [01. Overview](01-overview.md) | 개발 배경, 목적, 구현 범위와 개발 단계 |
| [02. Architecture](02-architecture.md) | 시스템 계층, 주요 클래스와 UI 구성 |
